      ...
      <div className="grid lg:grid-cols-2 gap-12 items-center">
        <div className="space-y-8">
          ...
          <div className="flex flex-wrap items-center justify-start gap-4 mb-4">
            <div className="flex items-center bg-blue-900 bg-opacity-50 px-4 py-2 rounded-full interactive-card">
              <FontAwesomeIcon icon={faBrain} className="text-blue-400 mr-2 pulse-on-hover" />
              <span className="text-blue-400 text-sm font-medium interactive-text">Advanced ML Models</span>
            </div>
            <div className="flex items-center bg-green-900 bg-opacity-50 px-4 py-2 rounded-full interactive-card">
              <span className="text-green-400 text-sm font-medium interactive-text">High Accuracy</span>
            </div>
            <div className="flex items-center bg-purple-900 bg-opacity-50 px-4 py-2 rounded-full interactive-card">
              <FontAwesomeIcon icon={faMagicWandSparkles} className="text-purple-400 mr-2 pulse-on-hover" />
              <span className="text-purple-400 text-sm font-medium interactive-text">Intelligent Analysis</span>
            </div>
          </div>
          <div className="grid grid-cols-4 gap-4">
            <div className="text-center interactive-card bounce-on-hover">
              <div className="text-3xl font-bold text-blue-400 interactive-text">88.56%</div>
              <div className="text-sm text-gray-400">Accuracy</div>
            </div>
            <div className="text-center interactive-card bounce-on-hover">
              <div className="text-3xl font-bold text-purple-400 interactive-text">6</div>
              <div className="text-sm text-gray-400">AI Models</div>
            </div>
            <div className="text-center interactive-card bounce-on-hover">
              <div className="text-3xl font-bold text-green-400 interactive-text">∞</div>
              <div className="text-sm text-gray-400">Learning</div>
            </div>
            <div className="text-center interactive-card bounce-on-hover">
              <div className="text-3xl font-bold text-pink-400 interactive-text">20+</div>
              <div className="text-sm text-gray-400">Features</div>
            </div>
          </div>
          <button
            onClick={onStartAssessment}
            className="magic-button text-white px-8 py-4 rounded-full font-semibold transition-all duration-300 transform click-ripple"
          >
        ...
        <div className="flex justify-center">
          <div
            ...
            className="neural-network-container relative cursor-pointer enhanced-particles"
          >
